package com.dj.sensitive.utils;
...
public class SensitiveWordEngine {
    ...
    public static SensitiveWordEngine initSensitiveWords(List<String> list) {
        SensitiveWordEngine engine = new SensitiveWordEngine();
        SensitiveWordInit sensitiveWordInit = new SensitiveWordInit();
        engine.sensitiveWordMap = sensitiveWordInit.initKeyWord(list);
        return engine;
    }
     ...
     * 获取敏感词内容
     * @param txt
     * @param matchType 0:只找第一个 1:获取全部
     * @return 敏感词内容
     */
     ...
     *
     * @param txt
     * @param matchType 0:只替换第一个 1:全部替换
